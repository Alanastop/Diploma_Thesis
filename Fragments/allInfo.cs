...
{
    public class allInfo : Android.Support.V4.App.Fragment
    {
        ...
        public override View OnCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
        {
            ...
            map.AddLayer(new LayerTile("http://192.168.1.3:100/fcgi-bin/mapserv.exe?map=C:/ms4w/apps/CA_ENCs/ENC_ROOT/Cal.map&&SERVICE=WMS&VERSION=1.3.0&REQUEST=GetMap&LAYERS=AEPARE,BEPARE,CEPARE,DEPARE,EEPARE,FEPARE,airports,cities&STYLES=&CRS=EPSG:4326&BBOX=-90.0,-180.0,90.0,180.0&WIDTH=2048&HEIGHT=2048&FORMAT=image/jpeg", 160));
